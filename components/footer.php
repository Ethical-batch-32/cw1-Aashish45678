<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>contact us</h3>
         <a href="#"><i class="fas fa-phone"></i> +9779743547819</a>
         <a href="#"><i class="fas fa-phone"></i> +9779843878432</a>
         <a href="#"><i class="fas fa-envelope"></i> evilsdead39@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span><b>Mr. Ashish Sapkota</b></span> | all rights reserved!</div>
